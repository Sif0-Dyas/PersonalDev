                ...
                <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl shadow-cyan-500/80 ring ring-2 ring-cyan-600 lg:max-w-xl">
                    ...
                    <form className="mt-6" onSubmit={submitHandler}>
                        ...
                        <div className="mb-2">
                            ...
                            <input
                                type="email"
                                className="block w-full px-4 py-2 mt-2 text-cyan-800 bg-white border rounded-md focus:border-blue-400 focus:ring-cyan-300 focus:outline-none focus:ring focus:ring-opacity-40" name='email' onChange={changeHandler}
                            />
